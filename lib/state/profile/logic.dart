...
import 'package:scanner/services/photos/photos.dart';
...
class ProfileLogic {
  ...
  final Web3Service _wallet = Web3Service();

  ProfileLogic(BuildContext context) : _state = context.read<ProfileState>();
  ...
  //     final config = _scanState.config;
  //     if (config == null) {
